...
// which printf features are supported. Also in this library are a variety of
// functions for fast printing of certain common data types (variable types).
// Functions include print string from RAM, print string from ROM, print
// string snippet, print hex byte/short/long, and a custom-formatted number
// print, as well as an optional floating-point print routine.
//
// All output from the rpintf library can be directed to any device or
// software which accepts characters. This means that rprintf output
...
//void rprintfProgStr(const char PROGMM str[]);
...
// A reduced substitue for the usual C printf() function.
