...
void dhcpInit(void)
{
	...
	DhcpTransactID = *(uint32_t*)macaddr; //  warning: dereferencing type-punned pointer will break strict-aliasing rules [-Wstrict-aliasing] by -Os option
	// can be ignored by -fstrict-aliasing option
	// reset lease time
	DhcpLeaseTime = 0;
}
