// This is a general network support library including a multitude of structure
// definitions for various types of network packets, functions and macros for
// switching byte order, and an RFC-compliant function for calculating checksums.
