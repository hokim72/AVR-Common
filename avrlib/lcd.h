...
// character LCD, those base on the HD44780 or SED1278 controller chip
...
// characters can allow you you to create animations or simple graphics. The
...
//
// For full text output functionality, you may wish to use the rprintf functions
...
#define LCD_ON_CUSOR			1	// DB1: turn cursor on
#define	LCD_ON_BLINK			0	// DB0: blingking cursor
...
// custtom LCD characters
extern const unsigned char PROGMEM LcdCustomChar[];
...
#define	LCDCHAR_FOWARDARROW				9	// fast-forward arrow
...
// such as clearing the display, setting cursor positions, displaying
// text and special characters

// initializes the LCD display (gets it ready for use)
void lcdInit(void);

// move the cursor/position to Home (upper left corner)
void lcdHome(void);
...
// ** this may not be accuate for all displays
