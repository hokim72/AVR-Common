...
// function pointer to single characer output routine
...
// *** rprintfStrLen ***
// prints a section of a sting stored in RAM
...
void rprintfStrLen(char str[], unsigned int start, unsigned int len)
{
	...
	// check to make sure we have a good pointer
	if (!str) return;
	// spin through characters up to required start
...
// see formating information below
